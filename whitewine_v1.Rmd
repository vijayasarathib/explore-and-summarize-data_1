...
```{r echo=TRUE, message=FALSE, warning=FALSE, toprecords}
head(whitewine)
tail(whitewine)
summary(whitewine)
...
```{r echo=TRUE, message=FALSE, warning=FALSE, datacheck}
...
```{r cho=FALSE, message=FALSE, warning=FALSE, acidityplot}
...
```{r echo=FALSE, message=FALSE, warning=FALSE, acidityboxplot}

qplot( x="whitewine", y = fixed.acidity, data = whitewine, geom = "boxplot")
